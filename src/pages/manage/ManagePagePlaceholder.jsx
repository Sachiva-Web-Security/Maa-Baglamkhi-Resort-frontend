const ManagePagePlaceholder = ({ title, description }) => (
  <div style={{ padding: "20px 28px", background: "#fff", minHeight: "100%" }}>
    ...
    >
      This page is coming soon. Share the fields/behavior you want and we'll build it.
    </div>
  </div>
);

export default ManagePagePlaceholder;
