...
const Employees = () => {
  ...
  const openEdit = (row) =>
    setModal({
      ...
      designation: row.designation || "CAPTAIN",
      address: row.address || "",
  ...
  const onSave = async () => {
    ...
    const payload = {
      name: modal.name,
      date_of_joining: modal.date_of_joining || null,
      designation: modal.designation || null,
      address: modal.address || null,
      mobile_number: modal.mobile_number || null,
        ...
        <table style={styles.table}>
          <thead>
            <tr>
              ...
              <th style={{ ...styles.th, width: 80, textAlign: "center" }}>Active</th>
            ...
            {rows.length === 0 && !loading && (
              <tr>
                <td colSpan={8} style={styles.empty}>
                  No employees yet. Click <b>+ New User</b> to add one.
                </td>
              </tr>
            )}
            {rows.map((row, idx) => (
              ...
              >
                ...
                <td style={styles.td}>{formatDMY(row.date_of_joining)}</td>
            ...
            <div style={styles.modalBody}>
              <div style={styles.field}>
                ...
                <input
                  ...
                  placeholder="e.g. MANISH SONANIYA"
                />
              </div>
              ...
              <div style={styles.field}>
                ...
                <input
                  ...
                  placeholder="e.g. GURADIYA KHATI"
                />
              </div>
