...
const Branches = () => {
  ...
  const onSave = async () => {
    ...
    const payload = {
      ...
      address1: modal.address1 || null,
      address2: modal.address2 || null,
      mobile1: modal.mobile1 || null,
      landline1: modal.landline1 || null,
    };
    setSaving(true);
    try {
      if (modal.mode === "add") {
        ...
        await API.put(`/branches/${modal.id}`, payload);
        ...
        <table style={styles.table}>
          <thead>
            <tr>
              ...
              <th style={styles.th}>Address 1</th>
              <th style={styles.th}>Address 2</th>
              <th style={styles.th}>Mobile 1</th>
              <th style={styles.th}>Landline 1</th>
            ...
            {rows.length === 0 && !loading && (
              <tr>
                <td colSpan={7} style={styles.empty}>
                  No branches yet. Click <b>+ New Branch</b> to add one.
                </td>
              </tr>
            )}
            {rows.map((row, idx) => (
              ...
              >
                ...
                <td style={styles.td}>{row.address1}</td>
                <td style={styles.td}>{row.address2}</td>
                <td style={styles.td}>{row.mobile1}</td>
                <td style={styles.td}>{row.landline1}</td>
            ...
            <div style={styles.modalBody}>
              <div style={styles.field}>
                ...
                <input
                  ...
                  placeholder="e.g. MAA BAGLAMUKHI RESORT"
                />
              </div>
              ...
              <div style={styles.row2}>
                ...
                <div style={styles.field}>
                  <label style={styles.label}>Landline 1</label>
                  <input
                    style={styles.input}
                    value={modal.landline1}
                    onChange={setField("landline1")}
                  />
                </div>
              </div>
            </div>
