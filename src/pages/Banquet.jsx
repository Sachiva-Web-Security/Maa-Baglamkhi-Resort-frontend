...
const Banquet = () => {
  ...
  const selectedHall = useMemo(
    () =>
      halls.find((h) => h.code === wizard.hallId || h.id === wizard.hallId) ||
      null,
    [halls, wizard.hallId],
  );
  ...
  const canNext = useMemo(() => {
    ...
    if (activeStep === 1)
      return (
        Boolean(wizard.customerName.trim()) && Boolean(wizard.phone.trim())
      );
    if (activeStep === 2)
      return (
        Boolean(wizard.date) &&
        Boolean(wizard.startTime) &&
        Boolean(wizard.endTime) &&
        wizardHours > 0
      );
  ...
  const hallStats = useMemo(() => {
    ...
    const completed = bookings.filter(
      (b) => b.status === "Completed" || b.status === "Billed",
    ).length;
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#071226] via-[#081827] to-[#041019] text-gray-100 p-4 sm:p-6 lg:p-8">
      <h1 className="text-2xl font-extrabold text-white mb-5">
        Banquet Management
      </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
        <div className="bg-[#071826] rounded-xl shadow p-4 border border-white/5">
          <div className="text-gray-300 font-extrabold text-xs mb-2">
            Total Halls
          </div>
      ...
      <div className="bg-[#071826] rounded-xl shadow overflow-hidden mb-5 border border-white/5">
        <div className="p-4 border-b border-white/5">
          ...
          <div className="text-gray-300 text-xs font-semibold mt-1.5">
            Select Hall → Details → Date/Time → Confirm → Completed → Bill
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, customerName: e.target.value }))
                  }
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  value={wizard.phone}
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, phone: e.target.value }))
                  }
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, eventType: e.target.value }))
                  }
                >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  value={wizard.guests}
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, guests: e.target.value }))
                  }
                  min={1}
                />
              </div>
              <div className="flex flex-col gap-1.5">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, menuPackageId: e.target.value }))
                  }
                >
                  {menuPackages.map((p) => (
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, decorationFee: e.target.value }))
                  }
                  min={0}
                />
              </div>
              <div className="flex flex-col gap-1.5 md:col-span-2">
                ...
                <textarea
                  ...
                  value={wizard.notes}
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, notes: e.target.value }))
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, startTime: e.target.value }))
                  }
                />
              </div>
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, endTime: e.target.value }))
                  }
                />
              </div>
              <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, discount: e.target.value }))
                  }
                  min={0}
                />
              </div>
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setWizard((p) => ({ ...p, gstPercent: e.target.value }))
                  }
                  min={0}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="border border-gray-200 rounded-xl p-3.5">
                  <div className="flex justify-between gap-2.5 py-2.5 border-b border-gray-100">
                    <span className="text-gray-600 font-extrabold text-xs">
                      Hall
                    </span>
                ...
                <div className="border border-gray-200 rounded-xl p-3.5">
                  ...
                  <div className="flex justify-between gap-2.5 py-2.5 border-b border-gray-100">
                    ...
                    <span className="text-gray-900 font-extrabold text-xs text-right">
                      {formatINR(wizardTotals.foodCharge)}
                    </span>
                  </div>
                  <div className="flex justify-between gap-2.5 py-2.5 border-b border-gray-100">
                    <span className="text-gray-600 font-extrabold text-xs">
                    ...
                    <span className="text-gray-900 font-extrabold text-xs text-right">
                      {formatINR(wizardTotals.decoration)}
                    </span>
                  </div>
                  <div className="flex justify-between gap-2.5 py-2.5 border-b border-gray-100">
                    <span className="text-gray-600 font-extrabold text-xs">
                    ...
                    <span className="text-gray-900 font-extrabold text-xs text-right">
                      - {formatINR(wizardTotals.discount)}
                    </span>
                  </div>
                  <div className="flex justify-between gap-2.5 py-2.5 border-b border-gray-100">
                    <span className="text-gray-600 font-extrabold text-xs">
                  ...
                  <div className="flex justify-between gap-2.5 py-2.5">
                    ...
                    <span className="text-gray-900 font-black text-xs text-right">
          ...
          {activeStep === 4 && (
            <div>
              ...
              <p className="text-gray-600 text-xs font-semibold mb-3">
                You can mark the event as completed from the booking list below,
          ...
          {activeStep === 5 && (
            <div>
              ...
              <p className="text-gray-600 text-xs font-semibold">
                Select a completed/confirmed event from the list and click
                "Generate Bill".
              </p>
            </div>
          )}
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <div className="p-4 border-b border-gray-200 flex items-baseline justify-between gap-3">
          ...
          <div className="text-gray-600 text-xs font-bold">
            Use actions to complete event and generate bill.
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-left">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-3 py-3 text-xs font-black text-gray-700">
                  Hall
                </th>
                <th className="px-3 py-3 text-xs font-black text-gray-700">
                  Customer
      ...
      <Modal
        ...
        title="Banquet Bill / Invoice (Demo)"
      >
        {selectedBooking ? (
          <BanquetBill
