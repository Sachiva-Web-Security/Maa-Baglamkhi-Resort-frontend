    ...
    const adminSidebarMenus = [
      ...
      },
      {
        ...
        children: [
          ...
          { name: "Price Groups", path: "/restaurant" },
          { name: "Print Groups", path: "/restaurant" },
          { name: "Item Groups", path: "/inventory" },
          { name: "Units", path: "/inventory" },
          { name: "Modifiers", path: "/restaurant" },
          { name: "Items", path: "/inventory" },
          { name: "Table Groups", path: "/restaurant" },
          { name: "Tables", path: "/restaurant" },
          { name: "Parcel Setting", path: "/restaurant" },
          { name: "Captains", path: "/user" },
          { name: "Invoices", path: "/accounts" },
          { name: "Edit Invoice", path: "/accounts" },
          { name: "Bar to Food", path: "/restaurant" },
          { name: "Room Service Settings", path: "/hotel" },
          { name: "Manage Data", path: "/reports" },
          { name: "Restaurant Settings", path: "/restaurant" },
          { name: "Restaurant POS", path: "/restaurant" },
          { name: "Kitchen", path: "/kitchen" },
          { name: "Quick Sales", path: "/restaurant" },
        ],
      },
      { name: "Inventory", path: "/inventory" },
      {
