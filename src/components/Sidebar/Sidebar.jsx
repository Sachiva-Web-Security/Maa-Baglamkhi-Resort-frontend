...
const Sidebar = ({ isMobile, sidebarOpen, setSidebarOpen, setIsAuthenticated }) => {
  ...
  const roleMenuMap = {
    admin: [
      ...
      { id: 108, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
    ...
    manager: [
      ...
      { id: 205, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 206, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 207, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 208, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 209, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 210, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
    ],
    receptionist: [
      ...
      { id: 308, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 309, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 310, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
    ],
    housekeeping: [
      { id: 401, name: "Room Status", icon: FaBroom, path: "/housekeeping", section: "operations" },
      { id: 402, name: "Notifications", icon: FaBell, path: "/housekeeping/notifications", section: "operations" },
      { id: 403, name: "Dirty Rooms", icon: FaTasks, path: "/housekeeping", section: "operations" },
      { id: 404, name: "Assignments", icon: FaClipboardList, path: "/assignments", section: "operations" },
      { id: 405, name: "Cleaned Rooms", icon: FaUserCheck, path: "/housekeeping", section: "operations" },
    ],
    accountant: [
