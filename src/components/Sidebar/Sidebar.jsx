...
const Sidebar = ({ isMobile, sidebarOpen, setSidebarOpen, setIsAuthenticated }) => {
  ...
  const roleMenuMap = {
    admin: [
      ...
      { id: 3, name: "Hotel", icon: FaHotel, path: "/hotel", section: "operations" },
      { id: 4, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 5, name: "Kitchen", icon: FaFire, path: "/kitchen", section: "operations" },
      { id: 8, name: "Housekeeping", icon: FaBroom, path: "/housekeeping", section: "operations" },
      { id: 9, name: "Assignments", icon: FaTasks, path: "/assignments", section: "operations" },
      { id: 10, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 6, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 7, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 11, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 12, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
      { id: 13, name: "User Management", icon: FaUserCheck, path: "/user", section: "records" },
    ],
    manager: [
      { id: 2, name: "All Bookings", icon: FaHotel, path: "/hotel/all-bookings", section: "operations" },
      { id: 6, name: "Housekeeping", icon: FaBroom, path: "/housekeeping", section: "operations" },
      { id: 7, name: "Assignments", icon: FaTasks, path: "/assignments", section: "operations" },
      { id: 8, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 9, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 3, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 4, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 5, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 14, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
    ],
    receptionist: [
      { id: 2, name: "Guest Booking", icon: FaHotel, path: "/hotel/guest", section: "operations" },
      { id: 3, name: "All Bookings", icon: FaClipboardList, path: "/hotel/all-bookings", section: "operations" },
      { id: 4, name: "Check-In / Out", icon: FaTasks, path: "/hotel/communication", section: "operations" },
      { id: 5, name: "Guest List", icon: FaUserCheck, path: "/hotel/booking-history", section: "operations" },
      { id: 7, name: "Assignments", icon: FaClipboardList, path: "/assignments", section: "operations" },
      { id: 8, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 9, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 6, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
    ],
    housekeeping: [
      { id: 2, name: "Room Status", icon: FaBroom, path: "/housekeeping", section: "operations" },
      { id: 3, name: "Dirty Rooms", icon: FaTasks, path: "/housekeeping", section: "operations" },
      { id: 4, name: "Assignments", icon: FaClipboardList, path: "/assignments", section: "operations" },
      { id: 5, name: "Cleaned Rooms", icon: FaUserCheck, path: "/housekeeping", section: "operations" },
    ],
    accountant: [
      { id: 3, name: "Assignments", icon: FaTasks, path: "/assignments", section: "operations" },
      { id: 2, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 4, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 5, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 6, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
    ],
    kitchen: [
      { id: 2, name: "Kitchen Orders", icon: FaFire, path: "/kitchen", section: "operations" },
      { id: 3, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 4, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
    ],
    waiter: [
