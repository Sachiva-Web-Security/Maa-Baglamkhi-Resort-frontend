...
const Sidebar = ({ isMobile, sidebarOpen, setSidebarOpen, setIsAuthenticated }) => {
  ...
  const roleMenuMap = {
    admin: [
      ...
      { id: 106, name: "Assignments", icon: FaTasks, path: "/assignments", section: "operations" },
      { id: 107, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 108, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 109, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 110, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 111, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
      { id: 112, name: "User Management", icon: FaUserCheck, path: "/user", section: "records" },
    ],
    manager: [
      ...
      { id: 203, name: "Assignments", icon: FaTasks, path: "/assignments", section: "operations" },
      { id: 204, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 205, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 206, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 207, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 208, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 209, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
    ],
    receptionist: [
      ...
      { id: 305, name: "Assignments", icon: FaClipboardList, path: "/assignments", section: "operations" },
      { id: 306, name: "Banquet", icon: FaGlassCheers, path: "/banquet", section: "operations" },
      { id: 307, name: "Restaurant POS", icon: FaUtensils, path: "/restaurant", section: "operations" },
      { id: 308, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
    ],
    housekeeping: [
      { id: 401, name: "Room Status", icon: FaBroom, path: "/housekeeping", section: "operations" },
      { id: 402, name: "Dirty Rooms", icon: FaTasks, path: "/housekeeping", section: "operations" },
      { id: 403, name: "Assignments", icon: FaClipboardList, path: "/assignments", section: "operations" },
      { id: 404, name: "Cleaned Rooms", icon: FaUserCheck, path: "/housekeeping", section: "operations" },
    ],
    accountant: [
      { id: 501, name: "Assignments", icon: FaTasks, path: "/assignments", section: "operations" },
      { id: 502, name: "Accounts", icon: FaWallet, path: "/accounts", section: "records" },
      { id: 503, name: "Reports", icon: FaChartBar, path: "/reports", section: "records" },
      { id: 504, name: "Inventory", icon: FaBoxes, path: "/inventory", section: "records" },
      { id: 505, name: "Audit Logs", icon: FaHistory, path: "/reports/audit", section: "records" },
    ],
    kitchen: [
